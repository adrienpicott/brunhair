...
const MODULES = [
  ...
  { href: '/interventions', icon: '🗓️', title: 'Interventions', desc: 'What you applied, and when', ready: false },
  { href: '/routines', icon: '🔁', title: 'Routines', desc: 'Steps & adherence tracking', ready: false },
